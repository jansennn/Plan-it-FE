<template>
  <div class="section section-basic">
    <div class="container">
      <h2 class="text-left title">Trip Planner Benefit</h2>
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          <h1>1.</h1>
          <p class="h3">Research bot that works for you</p>
          <p>Matches your travel preferences with over 230,000,000 data points:</p>
          <ul>
      ...
      <div class="row">
        <div class="col-md-8">
          <h1 class="title-2">2.</h1>
          <p class="h3">Planning engine that helps you see & do more</p>
          <ul>
            <li>Optimizes your itinerary</li>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <h1>3.</h1>
          <p class="h3">Your complete trip in one place</p>
          <ul>
